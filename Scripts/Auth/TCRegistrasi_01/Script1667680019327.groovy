...
Mobile.tap(findTestObject('Object Repository/Auth/Register/android.view.View'), 0)

Mobile.tap(findTestObject('Object Repository/Auth/Register/android.widget.Button'), 0)
